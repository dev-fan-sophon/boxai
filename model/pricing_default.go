...
var defaultModelCatalogMetadataByName = map[string]defaultModelCatalogMetadata{
	...
	"seedance-2-0-mini":           mediaCatalogMetadata("ByteDance", "Mini Seedance 2.0 video generation model for lower-cost 480p and 720p text-to-video and image-to-video workflows.", "video,generation,text-to-video,image-to-video,fast", "Doubao.Color", []string{"text"}, []string{"video"}, []string{"video_generation"}),
