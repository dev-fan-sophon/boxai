...
var integrationProfiles = []IntegrationProfile{
	...
	{ID: "openai.video.create", Protocol: "openai", Operation: "video_create", NameKey: "OpenAI Video", Method: "POST", GatewayPathTemplate: "/v1/videos", AuthScheme: "bearer", ContentType: "application/json", DocsSlug: "openai-video-create", SampleKind: "openai_video"},
