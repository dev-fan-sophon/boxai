...
func GetStatus(c *gin.Context) {
	...
	data := gin.H{
		...
		"facebook_oauth":              system_setting.GetFacebookSettings().Enabled,
		"facebook_client_id":          system_setting.GetFacebookSettings().ClientId,
		"zalo_oauth":                  system_setting.GetZaloSettings().Enabled,
		"zalo_app_id":                 system_setting.GetZaloSettings().AppId,
		...
		"rewards_enabled":             operation_setting.IsRewardEnabled(),
	}
