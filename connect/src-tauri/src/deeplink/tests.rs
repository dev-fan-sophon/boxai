...
/// The scheme Connect registers with the OS must be the scheme the parser
/// accepts. Registering one and parsing another leaves deep-link import dead:
/// every URL the OS delivers is rejected, and nothing surfaces the mismatch.
#[test]
fn test_parse_accepts_the_registered_scheme() {
    let url = "boxaiconnect://v1/import?resource=provider&app=claude&name=Test%20Provider&endpoint=https%3A%2F%2Fyou-box.com&apiKey=sk-test-123";
