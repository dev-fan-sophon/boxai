...
func SetApiRouter(router *gin.Engine) {
	...
	internalActAsRouter.Use(middleware.InternalServiceAuth())
	{
		...
		internalActAsRouter.GET("/playground/assets/:id/parse/pages/:page", controller.GetPlaygroundAssetParsePage)
		internalActAsRouter.POST("/playground/assets/:id/parse/import", controller.ImportPlaygroundAssetParse)
...

	{
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				// compatibility with older clients and shares the same user budget.
		...
		subscriptionRoute.Use(middleware.UserAuth())
		{
			...
			subscriptionRoute.PUT("/self/overage", controller.UpdateSubscriptionOverage)
			subscriptionRoute.POST("/self/renewal", middleware.CriticalRateLimit(), controller.SubscriptionUpdateRenewal)
		...
		optionRoute.Use(middleware.RootAuth())
		{
			...
			optionRoute.POST("/exchange-rate/sync", controller.SyncExchangeRate)
