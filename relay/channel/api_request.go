...
// ApplyUpstreamBodyMetadata restores metadata net/http cannot infer after it
// wraps a ReplayableBody in req.Body.
...
func doRequest(c *gin.Context, req *http.Request, info *common.RelayInfo) (*http.Response, error) {
	...
	// Cached clients are shared, so customize redirect behavior on a shallow
