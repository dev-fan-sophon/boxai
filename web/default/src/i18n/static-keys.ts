...
export const STATIC_I18N_KEYS = [
  ...
  'Account and usage',
  'See your BoxAI account and usage without leaving Connect.',
  'Signed in-app updates',
  'Receive verified Connect updates directly inside the app.',
  ...
  'Discover a compatible model, then apply it in one click',
