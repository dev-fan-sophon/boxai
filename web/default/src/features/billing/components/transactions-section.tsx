        ...
        <div className='flex-1 space-y-1'>
          <div className='flex min-w-0 items-center gap-2'>
            ...
            <Button
              ...
              onClick={() => props.onCopy(record.trade_no)}
              aria-label={t('Copy')}
            >
              {props.copiedText === record.trade_no ? (
                <Check className='h-3 w-3' />
              ) : (
                <Copy className='h-3 w-3' />
              )}
            </Button>
            {props.isAdmin && record.user_id != null && (
              <StatusBadge
      ...
      {props.isAdmin && record.status === 'pending' && !isBankQR && (
        <div className='mt-4 flex justify-end'>
          <Button
            size='sm'
            variant='outline'
            onClick={() => props.onComplete(record.trade_no)}
...
/**
 * Top-up order history rendered inline on the billing page.
 */
