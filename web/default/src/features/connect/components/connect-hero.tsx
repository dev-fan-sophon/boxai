...
export function ConnectHero(props: {
    ...
    >
      ...
      <div className='relative mx-auto max-w-6xl'>
        <div className='max-w-3xl'>
          ...
          >
            {t('Point your AI coding clients at BoxAI, without editing a config file')}
          </h1>
          <p
