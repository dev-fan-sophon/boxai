...
func printHelp() {
	fmt.Println("BoxAI " + Version + " - LLM gateway and AI asset management system.")
	fmt.Println("Project: https://github.com/dev-fan-sophon/boxai")
	fmt.Println("Usage: new-api [--port <port>] [--log-dir <log directory>] [--version] [--help]")
}
